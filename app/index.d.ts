...
export declare function Repo<LeftEntity, RightEntity>(left: EntityTarget<LeftEntity>, right: EntityTarget<RightEntity>, config: JoinOption<LeftEntity, RightEntity>, callback?: <P>(selection: SelectQueryBuilder<P>, e1: LeftEntity, e2: RightEntity) => SelectQueryBuilder<P>): SelectQueryBuilder<LeftEntity | RightEntity>;
